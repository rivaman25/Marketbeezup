...
CREATE TABLE `envios` (
  ...
  CONSTRAINT `env_age_fk` FOREIGN KEY (`idAgencia`) REFERENCES `agencias` (`idAgencia`),
  CONSTRAINT `env_alm_fk` FOREIGN KEY (`idAlmacen`) REFERENCES `almacenes` (`idAlmacen`),
