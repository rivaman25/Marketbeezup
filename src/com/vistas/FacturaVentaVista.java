...
import com.controladores.FacturaVentaControlador;
 ...
 */
public class FacturaVentaVista extends javax.swing.JDialog {
     ...
     */
    public FacturaVentaVista(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        selectorFechaFactura.getDateEditor().getUiComponent().addKeyListener(new java.awt.event.KeyAdapter() {
            @Override
            public void keyPressed(java.awt.event.KeyEvent evt) {
                selectorFechaFacturaKeyPressed(evt);
            }
        });
    }
    ...
    public void actualizarVista(Articulo articulo) {
        ...
        if (articulo.getFacturaVenta() == null) {
            selectorFechaFactura.setDate(new java.util.Date(Main.fechaActual().getTime()));
        } else {
            textoNumeroFactura.setText(articulo.getFacturaVenta().getNumeroFactura());
            selectorFechaFactura.setDate(new java.util.Date(articulo.getFacturaVenta().getFechaFactura().getTime()));
        }
    ...
    /**
     * Añade el listener implementado en facturaVentaControlador a los botones
     * del formulario
     *
     * @param facturaVentaControlador
     */
    public void setControlador(FacturaVentaControlador facturaVentaControlador) {
        botonGuardar.addActionListener(facturaVentaControlador);
        botonGuardar.setActionCommand("GuardarNuevaFacturaVenta");
        botonCancelar.addActionListener(facturaVentaControlador);
        botonCancelar.setActionCommand("CancelarNuevaFacturaVenta");
    }

    /**
     * Devuelve un facturaVenta con los valores introducidos en el formulario
     *
     * @return FacturaVenta con los valores introducidos en el formulario
     */
    public FacturaVenta obtenerFacturaVenta() {
        FacturaVenta facturaVenta = new FacturaVenta();
        facturaVenta.setCodigoArticulo(articulo.getCodigoArticulo());
        facturaVenta.setMarketplace(articulo.getMarketplace());
        facturaVenta.setIdPedido(articulo.getIdPedido());
        facturaVenta.setNumeroFactura(textoNumeroFactura.getText());
        if (selectorFechaFactura.getDate() != null) {
            facturaVenta.setFechaFactura(new java.sql.Date(selectorFechaFactura.getDate().getTime()));
        }
        return facturaVenta;
    }
    ...
    public void selectorFechaFacturaKeyPressed(KeyEvent evt) {
    ...
    private void initComponents() {
        ...
        selectorFechaFactura = new com.toedter.calendar.JDateChooser();
        ...
        selectorFechaFactura.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.gridwidth = 2;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 0, 0);
        jPanel1.add(selectorFechaFactura, gridBagConstraints);

        textoNumeroFactura.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        textoNumeroFactura.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                textoNumeroFacturaKeyPressed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 0, 0);
        jPanel1.add(textoNumeroFactura, gridBagConstraints);
    ...
    private void textoNumeroFacturaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textoNumeroFacturaKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER)
            selectorFechaFactura.getDateEditor().getUiComponent().requestFocus();
    }//GEN-LAST:event_textoNumeroFacturaKeyPressed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FacturaVentaVista dialog = new FacturaVentaVista(new javax.swing.JFrame(), true);
    ...
    private com.toedter.calendar.JDateChooser selectorFechaFactura;
